...
def compute_molar_mass(symbol_quantity_list, periodic_table_list):
    ...
    for symbol_quantity in symbol_quantity_list:
        ...
        # Check if the symbol exists in the periodic table
        if symbol in periodic_table_list:
            atomic_mass = periodic_table_list[symbol][ATOMIC_MASS_INDEX]
...
def main():
    ...
    # that stores element symbols and the quantity of atoms of each element in the molecule.
    ...
    print("Number of Moles:", number_of_moles)
