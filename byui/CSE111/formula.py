...
def parse_formula(formula, periodic_table_list):
    ...
    Parameters
        ...
        periodic_table_list is the compound dictionary returned
    ...
    assert isinstance(periodic_table_list, dict), \
        "wrong data type for parameter periodic_table_list; " \
        f"periodic_table_list is a {type(periodic_table_list)} " \
